...
const LeftNav = compose(
  ...
  <Drawer {...props} docked={false}>
    <Link to='/exams' style={styles.noUnderline}>
      <MenuItem onClick={props.onRequestChange}>Exams</MenuItem>
    </Link>
    <Switch>
      <Route
        path='/exams/:id'
        render={({ match: { params: { id } } }) => (
          <div>
            <Link to={`/exams/${id}/questions`} style={styles.noUnderline}>
              <MenuItem onClick={props.onRequestChange}>Question</MenuItem>
            </Link>
            <Link to={`/exams/${id}/submissions`} style={styles.noUnderline}>
              <MenuItem onClick={props.onRequestChange}>Submission</MenuItem>
            </Link>
          </div>
        )} />
      <Route
