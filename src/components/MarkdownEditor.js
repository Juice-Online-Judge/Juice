    ...
    return (
      <div>
        <Toolbar>
          ...
          <ToolbarGroup>
            <ToolbarTitle>Markdown Editor</ToolbarTitle>
            <IconButton disabled={preview} onClick={this.handleBold}>
              <BoldIcon />
            </IconButton>
            <IconButton disabled={preview} onClick={this.handleItalic}>
              <ItalicIcon />
            </IconButton>
            <IconButton disabled={preview} onClick={this.handleBulleted}>
              <BulletedIcon />
            </IconButton>
            <IconButton disabled={preview} onClick={this.handleNumbered}>
              <NumberedIcon />
            </IconButton>
          </ToolbarGroup>
        </Toolbar>
