...
class QuestionRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'input.file.*'          => 'required|mimetypes:text/plain,inode/x-empty,application/octet-stream',
            ...
            'output.file.*'         => 'required|mimetypes:text/plain,inode/x-empty,application/octet-stream',
            'argument'              => 'array',
